...
const StyledNavBar = styled.div`
    ...
    #styled-navbar-content {
        ...
        #styled-navbar-content-icon {
            ...
            -webkit-mask: url('https://simpleicons.org/icons/icomoon.svg') no-repeat center;
            mask: url('https://simpleicons.org/icons/disroot.svg') no-repeat center;
        }
    ...
    return(
        <StyledNavBar>
            <div id="styled-navbar-content">
                ...
                <div id="styled-navbar-content-title">Neshicorp</div>
                <Button btype="icon-button" text="resources" icon="https://simpleicons.org/icons/adobephonegap.svg"/>
